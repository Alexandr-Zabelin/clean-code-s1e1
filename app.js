...
var incompleteTaskHolder=document.querySelector(".incomplete-tasks-section__task-list");//ul of #incompleteTasks
var completedTasksHolder=document.querySelector(".complete-tasks-section__task-list");//completed-tasks
